...
async def savegroup_and_welcome(bot, message):
    ...
    if temp.ME in r_j_check:
        if not await db.get_chat(message.chat.id):
            ...
            await bot.send_message(LOG_CHANNEL, script.LOG_TEXT_G.format(a=message.chat.title, b=message.chat.id, c=message.chat.username, d=total, e=r_j))       
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://t.me/moviesuploaderbotprovider"),
            InlineKeyboardButton('Owner', url="https://t.me/starkx77")
        ],[
