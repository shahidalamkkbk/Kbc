...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+sFln_UBbyUI1NWQ1")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/Allmovie4uuu")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Sʜᴏʀᴛɴᴇʀ Sɪᴛᴇ', url='https://mklinks.in')
        ],[
            InlineKeyboardButton('Hᴏᴍᴇ', callback_data='start'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Shahilakhtar")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        if settings["button"]:
            cap = f"<b>🎬Mᴏᴠɪᴇs Nᴀᴍᴇ :- [{search}]\n🙎Rᴇǫᴜᴇsᴛ Bʏ :- [{message.from_user.mention}]\n💥Sʜᴏᴡ Rᴇsᴜʟᴛ Tɪᴍᴇ :- [{remaining_seconds}] sᴇᴄᴏɴᴅs\n👪Gʀᴏᴜᴘ :- [{message.chat.title}] \n\n<a 📎Pᴏᴡᴇʀᴇᴅ Bʏ :- href=https://t.me/Stark_Botz7>Sᴛᴀʀᴋ Bᴏᴛᴢ™</a>\n\n</b>"
        else:
